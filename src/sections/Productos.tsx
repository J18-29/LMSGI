const Productos = () => {
  ...
  <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
    <h2 className="text-2xl font-bold tracking-tight text-gray-900">Los Clientes también compraron</h2>
      ...
      <div className="group relative">
        ...
        <div className="mt-4 flex justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Aspen blanco</p>
          </div>
          <p className="text-sm font-medium text-gray-900">$35</p>
        </div>
      </div>
      <div className="group relative">
        ...
        <div className="mt-4 flex justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Carbón</p>
          </div>
          <p className="text-sm font-medium text-gray-900">$35</p>
        </div>
      </div>
      <div className="group relative">
        ...
        <div className="mt-4 flex justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Puntos ISO</p>
          </div>
          <p className="text-sm font-medium text-gray-900">$35</p>
        </div>
      </div>
